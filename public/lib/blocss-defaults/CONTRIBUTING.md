# Contributing to Blocss: settings.defaults
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/settings.defaults
   # Navigate to the newly cloned directory
   cd settings.defaults
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/Blocss/settings.defaults
   ```
...
3. Never work directly on `master` or `develop`. Create a new topic branch (off the latest version of `develop`) to contain your feature, change, or fix:
