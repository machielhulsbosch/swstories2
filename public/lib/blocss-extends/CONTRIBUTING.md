# Contributing to Blocss: tools.extends
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/tools.extends
   # Navigate to the newly cloned directory
   cd tools.extends
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/Blocss/tools.extends
   ```
