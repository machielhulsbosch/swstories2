# Contributing to Blocss: atoms.normalize
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/atoms.normalize
   # Navigate to the newly cloned directory
   cd atoms.normalize
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/Blocss/atoms.normalize
   ```
